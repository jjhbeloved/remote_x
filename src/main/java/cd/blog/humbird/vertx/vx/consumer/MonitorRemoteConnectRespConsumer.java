 ...
 */
public class MonitorRemoteConnectRespConsumer<T> extends AbstractConsumer<T> {

    public MonitorRemoteConnectRespConsumer(Vertx vertx) {
        super(vertx, AddressTemplate.getMonitorRemoteConnectRespAddr());
    }
