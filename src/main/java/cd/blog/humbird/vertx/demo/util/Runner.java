package cd.blog.humbird.vertx.demo.util;
...
public class Runner {
    ...
    public static void runClusteredExample(Class clazz, ClusterManager manager) {
        runExample(CORE_EXAMPLES_JAVA_DIR, clazz, new VertxOptions().setClusterManager(manager).setClustered(true), null);
    }
    ...
    static class JSHttpSimpleFormUploadRunner {
        public static void main(String[] args) {
            Runner.runJSExample(
                    "io/vertx/example/core/http/simpleformupload/simple_form_upload_server.js");
        }
    }
    ...
    static class GroovyEventBusPointToPointReceiverRunner {
        public static void main(String[] args) {
            Runner.runGroovyExampleClustered(
                    "io/vertx/example/core/eventbus/pointtopoint/receiver.groovy");
        }
    }
    ...
    static class GroovyEventBusPointToPointSenderRunner {
        public static void main(String[] args) {
            Runner.runGroovyExampleClustered(
                    "io/vertx/example/core/eventbus/pointtopoint/sender.groovy");
        }
    }
    ...
    static class GroovyHttpSimpleFormRunner {
        public static void main(String[] args) {
            Runner.runGroovyExample(
                    "io/vertx/example/core/http/simpleform/simple_form_server.groovy");
        }
    }
    ...
    static class GroovyHttpSimpleFormUploadRunner {
        public static void main(String[] args) {
            Runner.runGroovyExample(
                    "io/vertx/example/core/http/simpleformupload/simple_form_upload_server.groovy");
        }
    }
    ...
    static class GroovyVerticleAsyncStartRunner {
        public static void main(String[] args) {
            Runner.runGroovyExample(
                    "io/vertx/example/core/verticle/asyncstart/deploy_example.groovy");
        }
    }
    ...
    static class RubyHttpSimpleFormUploadRunner {
        public static void main(String[] args) {
            Runner.runRubyExample(
                    "io/vertx/example/core/http/simpleformupload/simple_form_upload_server.rb");
        }
    }
